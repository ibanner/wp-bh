...
<?php if ( $product->is_in_stock() ) : ?>
	...
	<form class="cart" method="post" enctype='multipart/form-data' onsubmit="BH_EC_onUpdateCart('<?php echo $p_sku; ?>', '<?php echo $p_name; ?>', '<?php echo $category; ?>', '<?php echo $p_price; ?>', '<?php echo $p_currency; ?>', $(this).find('.quantity input[type=number]').val(), 'add'); return true;">
