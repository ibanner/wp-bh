	...
	function BH_get_event_purchase_btn($event_id) {
		...
		if ($payed) :
			...
			if (!$series) :
				...
				// regular event
				if ($ticket_net_link) :
					$btn = '<a class="btn green-btn event-ticket-net-link" href="javascript:openPopup(\'' . $ticket_net_link . '\')">' . $order_tickets_btn . '</a>';
				endif;
				...
				if ($ticket_net_link && $today <= $start_date) :
					$btn = '<a class="btn green-btn event-ticket-net-link" href="javascript:openPopup(\'' . $ticket_net_link . '\')">' . $purchase_series_btn . '</a>';
				else :
					foreach ($series as $event) :
						...
						if ($today <= $event_date && $event_ticket_net_link) :
							$btn = '<a class="btn green-btn event-ticket-net-link" href="javascript:openPopup(\'' . $event_ticket_net_link . '\')">' . $order_tickets_btn . '</a>';
							break;
						endif;
					endforeach;
				endif;
