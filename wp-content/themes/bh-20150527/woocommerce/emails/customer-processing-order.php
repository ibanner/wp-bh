													...
													<tr>
														<td valign="top">
															<div id="body_content_inner">
																...
																<p style="font-family: Arial, Helvetica, Sans-serif; text-align: <?php echo is_rtl() ? 'right' : 'left'; ?>"><?php _e( "Your order has been received and is now being processed. Your order details are shown below for your reference:", 'woocommerce' ); ?></p>
